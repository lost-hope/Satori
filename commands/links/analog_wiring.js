    ...
    async execute(interaction) {
        ...
        switch (number) {
            case '3':
                ...
                .setImage('https://github.com/lost-hope/Satori-Images/blob/main/12Vanalog_wiringRGB.png?raw=true');
                break;
            default:
                embed = new EmbedBuilder()
                .setColor(0x0099FF)
                ...
                .setURL('https://kno.wled.ge/basics/getting-started/')
                .setDescription('WLED can also control analog LEDs, but you will need additional hardware like MOSFETs for that.\nThere are two recommended MOSFETs, that are working with the ESP, but there are more out there:\n`IRLZ44N`\n`STP55NF06L`')
                .setImage('https://github.com/lost-hope/Satori-Images/blob/main/12Vanalog_wiring.png?raw=true');
                break;
        }
